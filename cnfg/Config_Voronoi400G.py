########################################################################################################################################################################
main_path = 'M:/RVE_Workflow/SaeedWorkflow/Python_Code-27-AUG-2024'     #main_path is directory where your programm directory
########################################################################################################################################################################

filename = 'Voronoi_400G.inp'        #Firsly you need know that your input_file should be in inp_file's directory and then write ypu input_filename here
output_file_name = 'Voronoi_400G'      #All output data will saved in result directory, but you need new file there and here should be your name of your new directory for saving output file
model_type = 'Voronoi'              #based on your input_file's model you need choose Voronoi or Voxel

number_of_grains = 400
nodes_length_type= 'mm'               #If you input_file's nodes in macrometer you need write µm or if milimeter you need write mm

########################################################################################################################################################################

surface_index = 47489                  #Start_index for element_face in surf_154 you should write max nodes from your node_def or smth
...
Node_Def = 'True'              #If True node_def will run or blank

Elem_Def = 'True'           #If True elements_def will run or blank

Set_Def = 'True'               #If True sets_def will run or blank

Interface = 'True'             #If True interface_element_def will run or blank Only for Voronoi, for defining you need True nodes_def, element_def, sets_def

CE_Def = ''                #If True CE_def will run or blank Only for Voxel for defining CP_def you need True nodes_def

CP_Def = 'True'                #If True CP_def will run or blank,Only for Voronoi defining CP_def you need True nodes_def, element_def, sets_def, interfaces

Orientation = 'True'           #If True orientations_def will run or blank
...
input_orientation_filename = '_red_orient_400_G_R0.txt' #Firsly you need know that your input_file should be in inp_file's directory and then write you input_filename of orientation file
output_orientation_filename = '_red_orient_400_G_R0.dat' #Output filename of orientation file
