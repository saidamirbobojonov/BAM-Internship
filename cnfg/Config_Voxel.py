########################################################################################################################################################################
main_path = 'M:/RVE_Workflow/SaeedWorkflow/Python_Code' #main_path is directory where your programm directory
########################################################################################################################################################################

filename = 'Voxel_2nd.inp'        #Firsly you need know that your input_file should be in inp_file's directory and then write ypu input_filename here
output_file_name = 'Voxel_2nd'      #All output data will saved in result directory, but you need new file there and here should be your name of your new directory for saving output file
model_type = 'Voxel'              #based on your input_file's model you need choose Voronoi or Voxel
...
Surf_Elem = ''               #If True surf_element will run or blank, for defining surf_154 for Voronoi you need True nodes_def, element_def, sets_def, interfaces or
...
Ansys_Input = 'True'       #If True ansys_input will run and gnerated ansys_files or blank
...
input_file_name_ansys = 'Ansys_Input_Temp.inp'        #Firsly you need know that your input_file should be in inp_file's directory and then write ypu input_file_name here
output_file_name_ansys = 'ansys_input'        #Directory for saving ansys_input output files
########################################################################################################################################################################
#Default Parametr
output_file_ansys = f'{main_path}/result/{output_file_name_ansys}' #It directory for result and in the end {var} for your new directory name
input_file_ansys = f'{main_path}/inp_file/{input_file_name_ansys}'#It directory for inp_file and in the end {var} for your input filename
